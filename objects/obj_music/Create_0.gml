...
add_music(rm_painter, mu_top, mu_top, true);
...
add_music(rm_pizzano, mu_top, mu_top, true);
add_music(hub_w3, mu_hubw0, mu_hubw0, true);
...
add_music(ruin_5, mu_ancient1, mu_ancientsecret, false);
add_music(ruin_6, mu_ancient2, mu_ancientsecret, false);
add_music(medieval_1, mu_pizzascape1, mu_pizzascapesecret, false);
add_music(medieval_2, mu_pizzascape1, mu_pizzascapesecret, false);
add_music(medieval_3, mu_pizzascape2, mu_pizzascapesecret, false);
...
add_music(dance_1_old, mu_dance2, mu_dancesecret, false);
...
audio_sound_loop_start(mu_noiselap, 0);
audio_sound_loop_end(mu_noiselap, 147.76);