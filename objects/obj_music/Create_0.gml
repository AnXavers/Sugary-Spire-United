...
add_music(rm_coneball, mu_danger, mu_coneball1, true);
add_music(tower_entrancehall, mu_tower1, mu_painter, true);
add_music(tower_johngutterhall, mu_tower1, mu_painter, true);
add_music(tower_1, mu_tower1, mu_painter, true);
add_music(tower_2, mu_tower2, mu_painter, true);
add_music(tower_3, mu_tower3, mu_painter, true);
add_music(tower_4, mu_tower4, mu_painter, true);
add_music(tower_5, mu_tower5, mu_painter, true);
