...
draw_option(480, 400 + ScrollY, "CHALLENGE LAP 3 AND 4", optionselected == 5);
draw_option(280, 450 + ScrollY, "ON", optionsaved_challengelaps);
draw_option(680, 450 + ScrollY, "OFF", !optionsaved_challengelaps);
