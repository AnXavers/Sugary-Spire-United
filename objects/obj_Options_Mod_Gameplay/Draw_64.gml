...
draw_option(480, 750 + ScrollY, "ATTACK MOVE", optionselected == 7);
draw_option(280, 800 + ScrollY, "DEFAULT", optionsaved_attackmove == 0);
draw_option(680, 800 + ScrollY, "GRAB", optionsaved_attackmove == 1);
