...
draw_option(180, 350 + ScrollY, "DEFAULT", optionsaved_inflapping == 1);
draw_option(480, 350 + ScrollY, "INFINITE", optionsaved_inflapping == 2);
draw_option(780, 350 + ScrollY, "CHALLENGE", optionsaved_inflapping == 3);
