...
draw_option(200, 1000 + ScrollY, "NEW SCORE FONT", optionselected == 7);
draw_option(150, 1050 + ScrollY, "ON", optionsaved_heatmeter);
draw_option(150, 1100 + ScrollY, "OFF", !optionsaved_heatmeter);
draw_option(200, 1150 + ScrollY, "NEW ANIMATIONS", optionselected == 8);
draw_option(150, 1200 + ScrollY, "ON", optionsaved_heatmeter);
draw_option(150, 1250 + ScrollY, "OFF", !optionsaved_heatmeter);
draw_option(200, 1300 + ScrollY, "NEW LEVEL DESIGN", optionselected == 9);
draw_option(150, 1350 + ScrollY, "ON", optionsaved_heatmeter);
draw_option(150, 1400 + ScrollY, "OFF", !optionsaved_heatmeter);
draw_option(200, 1450 + ScrollY, "E RANK STACKING", optionselected == 10);
