...
if (state == 70 || state == 3 || state == 69 || state == 5 || (state == 71 && mach2 >= 100) || (state == 31 && sprite_index != spr_crouchslip && movespeed >= 12) || state == 17 || state == 97 || state == 101 || (state == 104 && sprite_index != spr_pizzano_sjumpprepside) || state == 121 || (state == 28 && mach2 >= 100))
{
	...
	mach_aftimg = 0;
if (state != 72 && state != 98 && state != 65 && state != 9 && state != 32 && state != 96 && sprite_index != spr_crouchshoot && sprite_index != spr_skatecrouch && state != 64 && state != 28 && state != 31 && state != 73 && state != 67 && state != 66 && sprite_index != spr_pizzano_crouchslide && sprite_index != spr_playerN_jetpackslide)
