function scr_getinput()
{
	...
	key_sprint = keyboard_check(global.key_sprint) || gamepad_button_check(_dvc, global.key_sprintC) || gamepad_button_check(_dvc, gp_shoulderrb);
	key_sprint2 = keyboard_check_pressed(global.key_sprint) || gamepad_button_check_pressed(_dvc, global.key_sprintC) || gamepad_button_check_pressed(_dvc, gp_shoulderrb);
