/// @function bnet_instance_create_layer(x, y, layer, obj, id, *data, *cache, *room_id)
function bnet_instance_create_layer() {
	...
	*/
	...
	/// @param {string}	layer		The layer to assign the created instance to.
...
#region Example
	/*
		player = bnet_instance_create_layer(x, y, "instance", BNET_DEMO_OBJECT_PLAYER, bnet("id"), [], true, string(BNET_DEMO_ROOM_GAME_2));
	*/
#endregion
