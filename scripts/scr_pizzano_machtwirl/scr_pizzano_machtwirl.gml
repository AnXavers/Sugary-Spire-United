function scr_pizzano_machtwirl() //gml_Script_scr_pizzano_machtwirl
{
    ...
    if (key_attack && ((!grounded) || slopeCheck((x + xscale), y)) && scr_solid((x + xscale), y, 1) && (!(place_meeting((x + xscale), y, obj_destructibles))))
    {
