/// @function bnet_event_execute_broadcast_tcp(list, script_name, data)
function bnet_event_execute_broadcast_tcp(argument0, argument1, argument2) {
...
#region Example
	/*
		...
		bnet_event_execute_broadcast_tcp("client_id", "src_helloWorld", json_encode(map));
