function scr_characterglobal()
{
	switch (character)
	{
		...
		case "N":
			...
			spr_mach3hit = spr_pizzano_mach3
			...
			spr_rankbubble_D = spr_rankbubble_d;
			spr_rankbubble_Dfilled = spr_rankbubble_dfilled;
			spr_lungehit = spr_pizzano_lungehit;
			spr_confecti5_rank = spr_confecti5rank;
			spr_confecti4_rank = spr_confecti4rank;
			spr_confecti3_rank = spr_confecti3rank;
			spr_confecti2_rank = spr_confecti2rank;
		...
		case "C":
			...
			spr_ladderdown = spr_pizzelle_ladderdown;
			spr_keyget = spr_pizzelle_keyget;
			spr_crouchslip = spr_pizzelle_crouchslide;
		...
		case "V":
			...
			spr_piledriverstart = spr_pizzelle_piledriver
			spr_haulingstart = spr_pizzelle_haulingstart
			spr_haulingidle = spr_pizzelle_haulingidle
			spr_haulingfall = spr_pizzelle_haulingfall
			spr_haulingjump = spr_pizzelle_haulingjump
			...
			spr_downslopes = spr_pizzelle_downslopes
			spr_upslopes = spr_pizzelle_upslopes
			spr_ceilingcrash = spr_pizzelle_bump
			spr_machfreefall = spr_pizzelle_machfreefall
			spr_throwDonut = spr_pizzelle_throwDonut;
		...
		case "M":
			...
			spr_keyget = spr_pizzelle_keyget;
			spr_crouchslip = spr_peppino_crouchslip;
			spr_slippingonice = spr_pizzelle_slipnslide;
			spr_mach1 = spr_pizzelle_mach1;
			spr_mach2 = spr_peppino_mach;
			spr_mach3player = spr_peppino_mach4;
			spr_mach2ceiling = spr_pizzelle_climbceilingmach2;
			...
			spr_hurtidle = spr_pizzelle_hurtidle
			spr_hurtwalk = spr_pizzelle_hurtwalk
			spr_suplexmash1 = spr_peppino_suplexmash7
			spr_suplexmash2 = spr_peppino_suplexmash5
			spr_suplexmash3 = spr_peppino_suplexmash7
			spr_suplexmash4 = spr_peppino_suplexmash5
			spr_tackle = spr_pizzelle_tackle
			spr_airdash1 = spr_pizzelle_airdash1
			spr_airdash2 = spr_pizzelle_airdash2
			spr_keyget = spr_pizzelle_keyget
			spr_idle1 = spr_pizzelle_idle
			spr_idle2 = spr_peppino_idle2
			spr_idle3 = spr_pizzelle_idleanim3;
			spr_idle4 = spr_pizzelle_idleanim4;
			spr_parry1 = spr_pizzelle_parry1
			spr_parry2 = spr_pizzelle_parry2
			...
			spr_facestomp = spr_pizzelle_facestomp
			spr_freefall =  spr_pizzelle_freefall
			spr_freefall2 = spr_pizzelle_freefall
			spr_freefallland = spr_pizzelle_freefallland
			spr_donutSlam_intro = spr_pizzelle_donutSlam_intro;
			spr_candytransitionup = spr_pizzelle_candytransitionup;
			spr_candyup = spr_pizzelle_candyup;
