/// @function bnet_instance_update_player(*tick_rate, *room_id, *reliable);
function bnet_instance_update_player() {
...
#region Example
	/*
		is_local = bnet_instance_update_player(is_move? 1: -1);
	...
	*/
	...
	__bnet_is_local	 = bnet_info[? "owner_id"] == __BNET._bnet_id;
			...
			if(!__bnet_reliable){
				...
				if(_bnet_type == 0){
					...
					if(__bnet_room != undefined){
						...
						_bnet_sendError(_bnet_tcp_socket, _bnet_write_buffer, "304");
