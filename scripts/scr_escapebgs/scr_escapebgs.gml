function scr_escapebgs()
{
	if (global.panic == 1)
	{
		...
		layer_change_background(bg_waferback1_new, bgwafer_escape2)
        layer_change_background(bg_waferback2_new, bgwafer_escape1)
        layer_change_background(bg_waferclouds_new, bgwafer_escape3)
        layer_change_background(bg_wafersun_new, bgwafer_escape4)
        layer_change_background(bg_wafersky_new, bgwafer_escape5)
